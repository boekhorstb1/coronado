...
namespace Horde\Coronado\Driver;
use Horde\Coronado\Driver;
...
class SqlDriver extends Driver
{
    ...
    public function retrieve()
    {
        ...
        try {
            ...
            throw new CoronadoException('Issue Retrieving items', 0, $e);
        }
    ...
    public function store($data)
    {
        ...
        try {
            ...
            throw new CoronadoException($e->getMessage());
        }
    }
}
